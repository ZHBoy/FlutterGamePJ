...
class GameLotteryPage extends StatefulWidget {
  @override
  _GameLotteryPageState createState() => _GameLotteryPageState();
}

class _GameLotteryPageState extends State<GameLotteryPage> {
